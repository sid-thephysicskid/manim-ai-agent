"""
Manim API Documentation Source

This file contains excerpts from the Manim objects that are most common in our lessons.
Update this file regularly to reflect the latest correct signatures and documentation.
"""
